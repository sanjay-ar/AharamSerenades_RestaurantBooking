      ...
      <div className="flex flex-col items-center justify-center md:flex-row md:justify-between">
        ...
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0 md:text-xl">
          <motion.a
            ...
            target={"_blank"}
            rel="noreferrer"
            href="https://sanjay-portfolio.tech"
          ...
          <motion.a
            ...
            target={"_blank"}
            rel="noreferrer"
            href="https://www.linkedin.com/authwall?trk=bf&trkInfo=AQFXPrYJdmyuBwAAAYnUzy6YCX1cIsQHT49ciVZMrzuXau9vmECIZ8TknQYa7NHJUgjea4tngxORPSXDBuCgGvX1FV5Nb6-NpTwXx67q9vV92Q1RGpzEOm232JixsQKjFCKjfxM=&original_referer=&sessionRedirect=https%3A%2F%2Fwww.linkedin.com%2Fin%2Fsanjay-a-r-1044ba218%2F"
            className="text-textColor h-10 w-10 bg-primary rounded-full flex items-center justify-center"
          >
            <BsLinkedin />
          </motion.a>
          <motion.a
            ...
            target={"_blank"}
            rel="noreferrer"
            href="https://twitter.com/sanjux_"
            className="text-textColor h-10 w-10 bg-primary rounded-full flex items-center justify-center"
          >
            <BsTwitter />
          </motion.a>
          <motion.a
            ...
            target={"_blank"}
            rel="noreferrer"
            href="https://instagram.com/sanjux_l"
            className="text-textColor h-10 w-10 bg-primary rounded-full flex items-center justify-center"
          >
            <BsInstagram />
          </motion.a>
          <motion.a
            ...
            target={"_blank"}
            rel="noreferrer"
            href="https://facebook.com/sanjux_"
            className="text-textColor h-10 w-10 bg-primary rounded-full flex items-center justify-center"
          >
            <BsFacebook />
          </motion.a>
